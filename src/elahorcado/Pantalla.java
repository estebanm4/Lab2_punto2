...
public class Pantalla implements WindowListener , ActionListener {
    ...
    private Frame f,fv;
    private final int Intentos = 6;  // numero de intentos para 
    private Version vg;
    private Set registro = new HashSet();   //conjuntos para guardas las
    private Set aciertos = new HashSet();  // letras equivocadas, las
    private Set errores = new HashSet();// acertadas y las de la palabra.
    private Set alfabeto = new HashSet(); // aqui se guarda el alfabeto
    private String visible="",muestra="";
    
    private Panel p1,p2;   // Menus graficos para manejar el juego
    ...
    private Palabra adivina;   // instancia para controlar la palabra del jeugo
    private String palabra=""; // aqui se guarda la palabra a adivinar
    ...
    private MenuItem niv1, niv2, niv3;  // las categorias para adivinar palabras
    ...
    public Pantalla(String titulo){
        ...
        //menu2Op1.addActionListener(this);
       ...
       niv3.addActionListener(this);
        ...
        palabraAdivinar = new Label("Aciertos:");//new Label(adivina.generaPalabra(0));
        verificar = new Label("");
        boton = new Button[27];
        letra = 'A';
        for(int i=0; i<14;i++)  
        ...
        boton[14] = new Button("\u00d1");  // la latosa letra enie
    ...
    public void EntornoGrafico(){
        f.setSize(1200,900); // Tamaño de pantalla
...
// De aqui se controla el juego, con la interface mas simple ActionListener
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getActionCommand() == "Palabras"){
            ...
            palabraAdivinar.setText(muestra); System.out.println(registro);
            for(int i=0;i<boton.length;i++)
        ...
        //checando.setText(Boolean.toString(adivina.checaLetra(e.getActionCommand().charAt(0), palabra) ));
        //checando.setText(adivina.checaLetra(e.getActionCommand().charAt(0), palabra) );
